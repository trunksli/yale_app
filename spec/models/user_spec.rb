...
describe User do
 ...
 describe "when name is too long" do
  ...
  describe "return value of authenticate method" do
    before { @user.save }#saves user to database, retrieved with find_by_email with let
    let(:found_user) { User.find_by_email(@user.email) }#creates found_user symbol, set using find_by_email
